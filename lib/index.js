...
function Insight (options) {
  ...
  //writeKey
	...
	this.trackingProvider = options.trackingProvider || 'keen';
	this.writeKey = options.writeKey;
	this.projectId = options.projectId;
	this.os = osName();

	this.config = options.config || new Configstore('insight-' + this.projectId, {
...
Insight.prototype.track = function (eventCollection, data) {
	if (this.optOut) {
		return;
	}
